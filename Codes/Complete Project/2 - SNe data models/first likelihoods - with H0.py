...
# translate these to chi^2
heights_chi = -2*np.log(heights)

print(f'found chi^2 heights are {heights_chi}')
...
# plot as heatmap and then add contours
heatmap = ax1.pcolormesh(Hgrid/1000, Omgrid, chisq_array)
contourplot = ax1.contour(Hgrid/1000, Omgrid, chisq_array, heights_chi[::-1], cmap=cm.jet)
#ax1.clabel(contourplot)
fig1.colorbar(heatmap)
