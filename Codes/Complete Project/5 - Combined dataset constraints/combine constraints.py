...
'''
overlaid constraints, with H(z) from flat prior H_{0} marginalising
'''
...
'''
Multiplying likelihoods together for overall constraint from flat prior
in H0
'''
...
from flat prior over H0 H(z) result
...
'''
overlaid constraints, with H(z) from Gaussian prior H_{0} marginalising
'''
...
H0 = np.linspace(60, 80, 500)  # as in generating file
# defining Gaussian
...
'''
Multiplying likelihoods together for overall constraint from Gaussian prior
in H0
'''
...
'''
Marginalising over Om with flat prior to constrain opacity
from Gaussian prior over H0 H(z) result
NOTE --- only run once cell above has been run
'''
