'''
We quickly side step to look at a convergence study in Omega m
...
fig = plt.figure()
ax = fig.gca()
ax.set_xlabel(r'$Number \ of \ points \ in \ \Omega_{m} $', fontsize=16)
...
# get relative error and plot it
error = abs((np.diff(Om_result) / Om_result[:-1])*100)
