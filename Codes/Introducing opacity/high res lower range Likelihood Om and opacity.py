...
fig5 = plt.figure()
ax5 = fig5.gca()
ax5.set_ylabel(r'$Likelihood \ marginalised \ over \ H_{0} \ and \ \Omega_{m} \ L(\epsilon)$', fontsize=16)
ax5.set_xlabel(r'$\epsilon$', fontsize=16)
...
print(f'eps = {round(eps_found[0], 6)}')
print('\n')
print(f'with confidence: \n')
print(f'                +{round(confidence1[0], 7)}')
print(f'                -{round(confidence2[0], 7)}')
